    ...
    def generate(self):
        if len(self.word) % 2 == 0:
           # Pytt('error, la palabra debe ser palindrome impar por favor intente de nuevo')
            messagebox.showerror("Error","La palabra debe ser palindrome impar")
    ...
    def exec(self):
        ...
        try:
            ...
            if is_valid:
                ...
                messagebox.showinfo("Bueno","Es un palindrome")
        except:
          # Pytt("ERROR, La palabra no es palindrome por favor intente de nuevo")
            messagebox.showerror("ERROR", "La palabra no es palindrome por favor intente de nuevo")
...
#------------------------------------------------------------------------------------------------
        ...
        time.sleep(2 if mode == 1 else 0.1)
